...
package com.app.aihealthapp.core.kprogresshud;
...
public class KProgressHUD {
    ...
    public KProgressHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.pickerview_bgColor_overlay);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
   ...
   */
    ...
    public KProgressHUD show(String title){
        if (!isShowing()) {
            setLabel(title);
            mFinished = false;
            if (mGraceTimeMs == 0) {
