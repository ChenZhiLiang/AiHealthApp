...
import com.app.aihealthapp.core.permission.source.AppActivitySource;
import com.app.aihealthapp.core.permission.source.ContextSource;
import com.app.aihealthapp.core.permission.source.FragmentSource;
import com.app.aihealthapp.core.permission.source.Source;
import com.app.aihealthapp.core.permission.source.SupportFragmentSource;
...
public class AndPermission {
    ...
    public static SettingService permissionSetting(@NonNull Activity activity) {
        return new com.app.aihealthapp.core.permission.setting.PermissionSetting(new AppActivitySource(activity));
    }
    ...
    public static SettingService permissionSetting(@NonNull android.support.v4.app.Fragment fragment) {
        return new com.app.aihealthapp.core.permission.setting.PermissionSetting(new SupportFragmentSource(fragment));
    }
    ...
    public static SettingService permissionSetting(@NonNull android.app.Fragment fragment) {
        return new com.app.aihealthapp.core.permission.setting.PermissionSetting(new FragmentSource(fragment));
    }
    ...
    public static SettingService permissionSetting(@NonNull Context context) {
        return new com.app.aihealthapp.core.permission.setting.PermissionSetting(new ContextSource(context));
    }
