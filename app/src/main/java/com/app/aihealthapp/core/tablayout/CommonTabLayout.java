package com.app.aihealthapp.core.tablayout;
...
import com.app.aihealthapp.core.tablayout.utils.FragmentChangeManager;
import com.app.aihealthapp.core.tablayout.utils.UnreadMsgUtils;
import com.app.aihealthapp.core.tablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //create ViewPager
        if (Integer.parseInt(height)!=ViewGroup.LayoutParams.MATCH_PARENT && Integer.parseInt(height)!=ViewGroup.LayoutParams.WRAP_CONTENT ) {
