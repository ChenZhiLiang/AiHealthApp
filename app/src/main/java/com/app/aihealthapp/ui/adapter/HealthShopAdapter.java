 ...
 * 修改人：Chen
 * 修改时间：2019/8/17 10:39
 */
public class HealthShopAdapter extends BaseAdapter {

    private List<GoodsCateListBean> data;//数据

    private Activity activity;//上下文

    public HealthShopAdapter(Activity activity, List<GoodsCateListBean> data) {
        this.data = data;
